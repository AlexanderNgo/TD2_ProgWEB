...
{
    var plus = id;
    var selected_plus = document.getElementById(plus);
    console.log("L'ID est : "+plus);
    var reponse = document.getElementById("Reponse"+id[id.length-1]);
    console.log("La reponse est : "+id[id.length-1]);
    reponse.style.display = "none";
    console.log("Style :"+reponse.style.display);
    selected_plus.addEventListener('click',() =>{
